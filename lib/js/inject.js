...
var bobTheBuilder = project => {
  ...
  var modalTrigger = $(`<button class="btn btn-primary modButt waves-effect" data-toggle="modal">Click me for more info</div>`).attr('data-target', idTargeteSpy()); //Has to be added in before the modal, and must be decalred before the append
 //appending to card
...
cfDiv.append(imgage).attr('height:', '240px').attr('width:', '240px')
