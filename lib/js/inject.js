...
var bobTheBuilder = project => {
  ...
  */
  ...
  var modalTrigger = $('<button class="btn btn-primary" data-toggle="modal" data-target="#modalUno">Click me for more info</div>') //Has to be added in before the modal, and must be decalred before the append
 //appending to card
...
var teamMems = project.team[i] //Student first and last name
var teamList = $(`<div class='theSquad'> ${teamMems} </div>`) //NOTE this will likeley need some css as it's going to be an array if I'm correct

//Making the divs
var modalPart1 = $('<div class="modal fade" id="modalUno" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"></div>') //main modal div
...
var modalPart7 = $(`<div class="modal-body" id="modalcontent">${bigDesc}</div>`) //Nested under modal content
